function writeMeshToVTKFile(mesh, u, vtkfile)
...
first_number = 1;
  ...
  type = 0;
  if (strcmp(mesh.grid_type, 'triangles'))
     type = 5;
  elseif (strcmp(mesh.grid_type, 'quadrilaterals'))
     type = 9; %VTK_QUAD
  elseif (strcmp(mesh.grid_type, 'hexahedra'))
